        ...
        <v-list>
          ...
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                <Edit :val="data.info.auto_renew" label="Auto renew" name="auto_renew" :path="'domains/' + this.domainId + '/update'" yesno /> 
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
          <v-divider></v-divider>
          ...
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                <div v-for="(item, key) in data.info.nameservers" v-bind:key="key">
                  {{item}}
                </div>
              </v-list-item-subtitle>
            </v-list-item-content>
