  ...
  export default {
    ...
    methods: {
      fetchData () {
        ...
        api.get('users/' + this.id + '/invoices')
      ...
      saveItem () {
        ...
        if (this.data.items.length) {
          ...
          api.post('users/' + this.id + '/invoices', this.data)
          .then(function (response) {
            console.log(response)
      ...
      deleteItem (id) { 
        this.$confirm('Delete invoice?').then(res => {
            ...
            api.post('users/' + this.id + '/invoices', {delete: 1, domain: id})
            .then(function (response) {
                console.log(response)
      ...
      view(id) {
        ...
        var self = this
        self.fetching = true
        api.get('users/' + this.id + '/invoices/' + this.invoice_id)
        .then(function (response) {
